...
import (
	...
	"qingyun/services/fishing_user/internal/logic/mobile"
...
func main() {
	...
	if err = mobile_fishing_user.RegisterMobileFishingUserServiceHandler(service.Server(), mobile.NewMobileFishingUserService(ctx)); err != nil {
		logger.Fatal(err)
	}
	service.Run()
