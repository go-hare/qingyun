...
import (
	...
	"qingyun/services/book-keeping/internal/logic/mobile"
...
func main() {
	...
	if err = mobile_book_keeping.RegisterBookKeepingServiceHandler(service.Server(), mobile.NewMobileBookKeepingService(ctx)); err != nil {
		logger.Fatal(err)
	}
	service.Run()
